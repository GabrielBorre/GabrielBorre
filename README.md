...
| **TP de Teoría de Control** | Realizamos un programa que busca emular el comportamiento de un controlador PID en los sistemas de control térmico en datacenters. El mismo tenía la intención de representar gráficamente como funciona cada uno de los componentes del controlador, como el componente proporcional, el integral y el derivativo. | **Python, JupyterLab,bibliotecas para mostrar gráficos como plotly** | [Ver Repositorio](https://github.com/GabrielBorre/Simulacion_TDC_2025_K4051) |
---
